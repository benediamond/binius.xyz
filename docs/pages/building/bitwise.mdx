# Bitwise Constraints [A simple example of a constraint system]
...
To see this example and other bitwise examples for XOR and OR, visit [Binius examples](https://github.com/IrreducibleOSS/binius/blob/main/crates/circuits/src/bitwise.rs).
