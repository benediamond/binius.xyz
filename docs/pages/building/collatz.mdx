...
To see the example in full, visit [circuits/collatz](https://github.com/IrreducibleOSS/binius/blob/main/crates/circuits/src/collatz.rs) for the implementation of Collatz, and visited [examples/collatz](https://gitlab.com/IrreducibleOSS/binius/-/blob/main/mpt/collatz.rs) for the prove and verify functions.
