...
The [boundary values](https://docs.binius.xyz/binius_core/constraint_system/channel/struct.Boundary.html) are integral to our arithmetization techniques and are [introduced here](/basics/arithmetization/m3/definition#boundary-conditions). They are what allow the verifier to connect the proof received to the statement proven. While the prover doesn't need the boundary values, the prover must often help construct the boundary values and give them to the verifier as advice.
