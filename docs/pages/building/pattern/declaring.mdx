...
For details on creating virtual polynomials, for example to see what checks are applied to parameters, see [MultilinearOracleSet](https://gitlab.com/IrreducibleOSS/binius/-/blob/main/crates/core/src/oracle/multilinear.rs).
