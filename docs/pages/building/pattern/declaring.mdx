...
For details on creating virtual polynomials, for example to see what checks are applied to parameters, see [MultilinearOracleSet](https://github.com/IrreducibleOSS/binius/blob/main/crates/core/src/oracle/multilinear.rs).
...
There are many specialized transparent constructions in [Binius transparents](https://github.com/IrreducibleOSS/binius/tree/main/crates/core/src/transparent) that are easily created. For example, suppose we wish to take a field element and create a column with values had by taking consecutive powers of the elements. The transparent [powers](https://github.com/IrreducibleOSS/binius/blob/main/crates/core/src/transparent/powers.rs) lets us do this.
