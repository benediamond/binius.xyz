...
On this page we design a lookup gadget, discussing the concepts of "multiplicities" and "components" we'll use to implement it. A central sub-gadget will be `get_components` which we'll use in blackbox fashion on this page and construct on the [next page](/building/lookup/components).
