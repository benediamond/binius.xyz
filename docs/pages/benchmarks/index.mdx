...
We publish the benchmarks [here](https://github.com/IrreducibleOSS/leansig).
You can use scripts to reproduce benchmarks for [RISC Zero](https://github.com/IrreducibleOSS/leansig/blob/main/benchmark-risc0-cuda.sh) and [SP1](https://github.com/IrreducibleOSS/leansig/blob/main/benchmark-sp1-cuda.sh).
