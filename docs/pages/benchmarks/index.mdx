...
We believe that a fair metric by which to compare provers is _hashing throughput_, i.e. the amount of input data that these provers can generate a proof-of-hash about, per unit of time.
The following charts compare the hashing throughputs of Binius64, Plonky3 and Stwo provers, each generating proofs about Keccak-256 and Blake2s hashes.
We obtain results by proving hashes of 1 MiB of data using each of the provers.
